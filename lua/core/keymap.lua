...
keymap.set("n", "<leader>fc", function() vim.lsp.buf.format({ async = true }) end, { desc = "Format Code" })
...
keymap.set("n", "<leader>o", "<cmd>Lspsaga outline<CR>", { desc = "Outline View" })
keymap.set("n", "<leader>e", "<cmd>Lspsaga show_line_diagnostics<CR>", { desc = "Show Diagnostics" })
keymap.set("n", "<leader>gw", "<cmd>Lspsaga show_workspace_diagnostics<CR>", opts)
keymap.set("n", "<leader>ca", "<cmd>Lspsaga code_action<CR>", opts)
keymap.set("n", "<leader>gn", "<Cmd>Lspsaga diagnostic_jump_next<CR>", opts)
keymap.set("n", "<leader>gp", "<Cmd>Lspsaga diagnostic_jump_prev<CR>", opts)
keymap.set("n", "<leader>gP", "<Cmd>Lspsaga peek_definition<CR>", opts)
keymap.set("n", "<leader>gf", "<cmd>Lspsaga finder<CR>", { desc = "Show Finder" })
