...
keymap.set('n',',ev',':tabnew $MYVIMRC<CR>')
keymap.set('n',',ea',':tabnew $HOME/.bashrc<CR>')
keymap.set('n',',cr',':tabnew $HOME/.aws/credentials<CR>')
keymap.set('n',',cf',':tabnew $HOME/.aws/config<CR>')
...
keymap.set('n',',ga',':G add ')
keymap.set('n',',gA',':G add .<CR>')
keymap.set('n',',gc',':G commit<CR>')
keymap.set('n',',Gc',':G add .<CR>:G commit<CR>')
keymap.set('n',',gC',':G checkout ')
keymap.set('n',',gb',':G branch<CR>')
keymap.set('n',',gB',':G branch ')
keymap.set('n',',gm',':G merge ')
keymap.set('n',',gp',':G pull<CR>')
keymap.set('n',',gP',':G push<CR>')
keymap.set('n',',gl',':G log<CR>')
